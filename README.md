...
# ПРЕДУПРЕЖДЕНИЕ!
Представленные на данной странице ресурсы (ссылки, инструкции, скрипты и т.д.) могут использоваться только в ознакомительных целях. Они могут применяться только для обхода блокировок доступа к тем сайтам, которые намеренно заблокировали доступ к своему ресурсу пользователей относящихся к определенной геолокации (блокировка доступа к сайту пользователей определенной геолокации). Иное применение настоящих ресурсов (в том числе но не исключая случаев обхода блокировок) - недопустимо, если вы намеренны пользоваться настоящими ресурсами в иных, не разрешенных действующим законодательством вашей геолокации целей, то вы, используя настоящие ресурсы в запрещенных законом случаях, должны отказаться от использования настоящих ресурсов, а в случае привлечения вас к ответственности - берете на себя все возможные риски, в том числе но не исключая все убытки и расходы.
